...
public class DotsPanel extends JPanel {
	...
	private final int WIDTH = 600, HEIGHT = 600; // Screen size
	private final int ARRAY_SIZE = 10000; // Number of dots you can draw

	int x, y; // x-axis and y-axis speeds
	int max = 5, min = 5; // max and min speeds for the dots
	...
	public void paintComponent(Graphics page) {
		...
		for (Point spot : pointList) { // Keeps the dots the same color
	...
	// -----------------------------------------------------------------
	//	Changes the dots' speed based on the slider's value
	// -----------------------------------------------------------------
	...
	// --------------------------------------------------------------
	private class DotsListener implements ActionListener, MouseListener, MouseMotionListener, MouseWheelListener {
		...
		//--------------------------------------------------
		//	Change the size of the dots with the 
		//	mouse wheel
		//--------------------------------------------------
